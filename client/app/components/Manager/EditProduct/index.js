...
const EditProduct = (props) => {
  const { user, product, productChange, formErrors, brands, updateProduct, deleteProduct, activateProduct } = props;
    ...
    <div className="edit-product">
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        <div className="d-flex flex-column flex-md-row">
          ...
          <Button variant="danger" text="Delete" onClick={() => deleteProduct(product._id)} />
        </div>
      </form>
    </div>
  );
