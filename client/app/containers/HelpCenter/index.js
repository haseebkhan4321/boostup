  ...
  render() {
    return (
      <div className='shop buyCoin mb-10'>
        ...
        <h1 className='text-center mt-2 gold-color'>Get Help</h1>
          </Col>
        ...
        <div>
            ...
            <Col xs='12' lg='12' sm='12' md='12' className='mb-3 px-0 recharge-balance width-80'>
              ...
              <p className='px-4 text-left font-size-10'>Contact us on WhatsApp</p>
              </div>
              <div className='m-auto p-2 mx-2 w-50 personal-account width-40'>
              <div className='px-0 buycoin-btn py-2'>
                <h1 className='py-2 px-4 bg-gold ok-to-recharge font-size-10'>WhatsApp</h1>  
                </div>
              </div>
            </Col>
            <Col xs='12' lg='12' sm='12' md='12' className='mb-3 px-0 recharge-balance width-80'>
